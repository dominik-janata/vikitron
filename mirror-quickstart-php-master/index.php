...
switch ($_POST['operation']) {
  ...
  case 'insertSubscription':
      echo $base_notification_url . "/notify.php";
...
<div class="container">
          ...
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php
                  if ($timeline_item->getMenuItems() != null) {
                    $menuItems = $timeline_item->getMenuItems();
                    foreach ($menuItems as $menuItem) { ?>
                    <?php echo $menuItem->getAction(); ?>
                    <?php
                    }
                  }
                  ?>
  ...
  <div class="row">
    <div class="span4">
      ...
      <hr>
      <form method="post">
        <input type="hidden" name="operation" value="insertDefaultCard">
        <button class="btn btn-block" type="submit">
          Insert default card
        </button>
      </form>
